...
const FooterComponent = () => {
  const encoded = btoa("+1 9452162623");
  return (
    <React.Fragment>
      {/*Footer component */}
      <div className="footer-container">
        {/**Footer component## Github, linkedin, phone number and email */}
        <div className="footer-container-media">
          <div className="footer-container-github-linkedin">
            <a
          ...
          {/**Footer component## Contact information */}
          <div className="footer-container-phoneno-gmail">
            {/**Footer component## Contact information ## phone number icon*/}
            <a
              href={`tel:${atob(encoded)}`}
              className="footer-container-contact-info phone-number"
            >
              {" "}
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            {/**Footer component## Contact information ## email icon*/}
            <a
              className="footer-container-contact-info gmail"
              href="mailto:akhilveluru@outlook.com"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
